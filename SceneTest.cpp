...
int main()
{
    ...
    // add floor
    Material floorPlaneMt(Color(Vec3(0.01)), Color(Vec3(0.69)), Color(Vec3(0.3)), Vec3(4));
    scene.add(new Plane(Vec3(0, -1, 0), Vec3(0, 1, 0), floorPlaneMt));
 ...
 //   scene.addLight(new PointLightSource(Vec3(-5, 5, -5), Color(Vec3(0.5))));
  //  scene.addLight(new PointLightSource(Vec3(5, 0, -5), Color(Vec3(0.5))));
    scene.addLight(new PointLightSource(Vec3(5, 5, 15), Color(Vec3(0.5))));
